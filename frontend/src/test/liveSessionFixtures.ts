...
export function createLiveSessionInput(): LiveSessionModelInput {
  return {
    ...
    participants: [
      ...
      participant('participant-3', 'player-3', 3, 'REGISTERED'),
      participant('participant-4', 'player-4', 4, 'PAUSED'),
      participant('participant-5', 'player-5', 5, 'PLAYING'),
      participant('participant-6', 'player-6', 6, 'PLAYING'),
      participant('participant-7', 'player-7', 7, 'PLAYING'),
      participant('participant-8', 'player-8', 8, 'PLAYING'),
    ],
    players: [
